...
export default class Main extends Component {
  ...
  componentDidMount() {
    this.displayPicture = setInterval(() => {
  ...
  componentWillUnmount() {
    clearInterval(this.displayPicture);
  }
      ...
      <div className="Main">
        ...
        <div className="runningFastPack">
          ...
          <div className="fastText">
            <span>
              새롭게 출시된 나이키 패스트 팩과 함께 마라톤 시즌을 준비하고 러닝
              목표를 달성해보세요.
            </span>
          </div>
        ...
        <div className="flyNeat">
          ...
          <div>
            <span>
              ...
              2020. <br />
              새로운 컬러로 출시된 에어 베이퍼맥스 2020과 함께 지속가능성을 향한
              여정에 동참해보세요.
            </span>
          </div>
        ...
        <div className="highAvailability">
          ...
          <div className="availabilityText">
            <span>
              활용도 높은 디자인으로 다양한 스타일과 믹스매치 할 수 있는 나이키
              레이어드 스타일링을 소개합니다.
